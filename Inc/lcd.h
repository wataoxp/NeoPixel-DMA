...
static inline void SetCusor(I2C_TypeDef *I2Cx, uint8_t x,uint8_t y)
{
	...
	//uint8_t pos = DDRAM_ACCESS | (x + y * ENTER_CUSOR);
	uint8_t pos = DDRAM_ACCESS | ((x + y * ENTER_CUSOR) & ~DDRAM_ACCESS);
	PushI2C_Mem_Write(I2Cx, LCD_ADDRESS, pos, CMD_CTRL, I2C_MEMADD_SIZE_8BIT);
}
